...
<div class="container py-2 py-md-3">
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-4"><div class="card"><div class="card-body"><div class="text-muted small">Assigned deliveries</div><div class="h4 mb-0">{{ $stats['assigned'] }}</div></div></div></div>
