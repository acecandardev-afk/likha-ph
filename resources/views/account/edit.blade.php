            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('account.update') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="city" class="form-label fw-medium">City / municipality</label>
...
document.addEventListener('DOMContentLoaded', function() {
    initLocationSelectors({
        ...
        savedCountry: 'Philippines',
        savedRegion: @json($selectedRegionId ?? null),
        savedProvince: @json($selectedProvinceId ?? null),
        savedCity: @json($selectedCityId ?? null),
        savedBarangay: @json($selectedBarangayId ?? null)
    });
});
</script>
@endpush
