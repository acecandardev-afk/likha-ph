                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 py-2 rounded-0 nav-account-dropdown">
                            ...
                            @elseif(auth()->user()->isArtisan())
                                ...
                                <li><a class="dropdown-item py-2" href="{{ route('artisan.returns.index') }}">Item returns</a></li>
                            ...
                            @elseif(auth()->user()->isCustomer())
                                ...
                                <li><a class="dropdown-item py-2" href="{{ route('customer.returns.index') }}">Returns</a></li>
